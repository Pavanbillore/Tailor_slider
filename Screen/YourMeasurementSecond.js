...
import { Text, Modal,View,TouchableOpacity,Image,StyleSheet,Button,Alert,ScrollView, Pressable } from 'react-native'
...
const YourMeasurementSecond = ({navigation}) => {
...
export default YourMeasurementSecond;